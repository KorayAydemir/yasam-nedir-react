...
export const CommentForm = ({ post }: any) => {
    ...
    if (hasSubmitted) {
        ...
        return (
            <>
                <h3>
                    Yorumunuz için teşekkürler! Yorumunuz onaylandıktan sonra
                    sitede gözükecektir.
                </h3>
                <ul>
                    <li>
    ...
    return (
        <>
            ...
            <form
                ...
                className="w-full max-w-lg text-[color:var(--font-color)] font-sans"
            >
                <input
                    {...register("post")}
                    type="hidden"
                ...
                <div className="mb-2 block reset">
